...
CONTAINS
  ...
  SUBROUTINE ComputeInternalEnergyDensityFromPressure_IDEAL &
               ( D, P, Y, Ev, Mask_Option )
  ...
  SUBROUTINE ComputePressureFromSpecificInternalEnergy_IDEAL &
               ( D, Em, Y, P, Mask_Option )
